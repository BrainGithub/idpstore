		...
		<footer className="border-neutral-300 bg-neutral-50">
			<div className="mx-auto max-w-7xl px-4 lg:px-8">
				...
				<div className="flex flex-col justify-between border-t border-neutral-200 py-10 sm:flex-row">
					<p className="text-sm text-neutral-500">Copyright &copy; {currentYear} zx, Inc.</p>
					<p className="flex gap-1 text-sm text-neutral-500">
						...
						idpc-store
						<Link
							href={"https://github.com/BrainGithub/idpc-store"}
							target={"_blank"}
							className={"opacity-30"}
						>
							{/* <Image alt="Saleor github repository" height={20} width={20} src={"/github-mark.svg"} /> */}
							<Image alt="idpc-store" height={20} width={20} src={"/github-mark.svg"} />
						</Link>
					</p>
				</div>
			</div>
